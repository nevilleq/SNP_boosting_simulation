...
#Test, make sure it works - all bueno
#Time it for 10
#a <- Sys.time()
#sim_diagnose(sim.df$data[[180]], sim.df$best_params[[180]], n = 5)
#b <- Sys.time()
#(b - a)
#1.374909 mins for 10  for smallest data
#6.335516 mins for 50
...
read_rds("./data/results/sim_cv_results/cv_result_180.RDS")
